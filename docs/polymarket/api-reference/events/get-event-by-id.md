---
url: "https://docs.polymarket.com/api-reference/events/get-event-by-id"
title: "Get event by id - Polymarket Documentation"
---
...
- negRiskFeeBips: integer | null
- commentCount: integer | null
- imageOptimized: object
- iconOptimized: object
- featuredImageOptimized: object
...
- tags: object[]
- cyom: boolean | null
- closedTime: string<date-time> | null
...
- startTime: string<date-time> | null
- eventWeek: integer | null
...
- live: boolean | null
- ended: boolean | null
- finishedTimestamp: string<date-time> | null
- gmpChartMode: string | null
- eventCreators: object[]
- tweetCount: integer | null
- chats: object[]

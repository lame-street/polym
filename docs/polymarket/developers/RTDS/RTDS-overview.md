...
1. **CLOB Authentication**: Required for certain trading-related subscriptions   - `key`: API key
   - `secret`: API secret
   - `passphrase`: API passphrase
2. **Gamma Authentication**: Required for user-specific data   - `address`: User wallet address
...
[Market Channel](https://docs.polymarket.com/developers/CLOB/websocket/market-channel) [RTDS Crypto Prices](https://docs.polymarket.com/developers/RTDS/RTDS-crypto-prices)

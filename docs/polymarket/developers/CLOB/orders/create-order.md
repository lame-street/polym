...
title: "Place Single Order - Polymarket Documentation"
---
...
[Orders Overview](https://docs.polymarket.com/developers/CLOB/orders/orders) [Place Multiple Orders (Batching)](https://docs.polymarket.com/developers/CLOB/orders/create-order-batch)
